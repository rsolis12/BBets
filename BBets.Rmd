...
```
The plot will show the relationship between the class size and Professor Brownlow's expected profits. The class size for which the expected profits are closest to zero would be the size that makes the 2:1 bet fair. You can check the plot to find the approximate class size that fulfills this condition.
